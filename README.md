...
## Actively Maintained Product Portfolio

**12 active products** · **⭐ 220 public stars** · **5,676 commits since 2026-01-01**


| Product | Active | Days | Commits | Stack |
|---|---:|---:|---:|---|
| 🟣 [Advance](https://github.com/Sharper-Flow/Advance) | 60.6% | 63 | 1,129 | OpenCode plugin · TypeScript · Temporal |
| 🟠 [Vision](https://github.com/Sharper-Flow/Vision-MCP-Manager) | 19.6% | 21 | 100 | Go · MCP routing · daemon architecture |
| 🟣 [OpenCode Advance](https://github.com/Sharper-Flow/Opencode-Advance) | 58.6% | 17 | 216 | Go CLI · OpenCode env mgmt · Temporal supervision |
| 🟡 [lgrep](https://github.com/Sharper-Flow/lgrep) | 18.2% | 16 | 86 | Python · semantic code search · MCP |
| 🟣 [Model Preferences](https://github.com/JRedeker/opencode-model-preferences) | 16.3% | 14 | 43 | Go · OpenCode plugin |
